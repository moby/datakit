...
val pr_url : Repo.t -> int -> string
(** [pr_url r pr] is a link to the page for [pr]. *)

val ref_url : Repo.t -> Ref.name -> string
(** [ref_url r ref] is a link to the page for [ref]. *)

val unescape_ref : string -> Ref.name
(** [unescape_ref s] decodes a percent-encoded query parameter
    previously generated by these templates. *)
