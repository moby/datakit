...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4d728745d4b3e9536f068f47af80886f) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "db.ml"});
               Executable
                 ({
                     cs_name = "mount_9p";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "mount.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "y&\218\255b9,\020?\237\135\238\b\\\"\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
