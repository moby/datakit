...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4ac86bd1ce7371ce1bc35ae80e36a80c) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_datakit", ["-q"]))];
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Common_worker"];
                      lib_findlib_parent = Some "datakit";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "datakit";
                           InternalLibrary "datakit-worker"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dk_show.ml"});
               Executable
                 ({
                     cs_name = "dk-work";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dk_work.ml"});
               Executable
                 ({
                     cs_name = "dk-schedule";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dk_schedule.ml"});
               Executable
                 ({
                     cs_name = "dk-add";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dk_add.ml"});
               Executable
                 ({
                     cs_name = "dk-publish";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dk_publish.ml"});
               Executable
                 ({
                     cs_name = "dk";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dk.ml"});
               Library
                 ({
                     cs_name = "datakit-github";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\142\015W|_\135Xɼ5P\130\031ǿ\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
